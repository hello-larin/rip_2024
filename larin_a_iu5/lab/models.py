...
class LaboratoryOrderItems(models.Model):
    ...
    order = models.ForeignKey(LaboratoryOrder, models.DO_NOTHING)
    product_id = models.ForeignKey(LaboratoryItem, models.DO_NOTHING)

    class Meta:
        managed = False
        db_table = 'laboratory_order_items'
        unique_together = (('order', 'product_id'), ('order', 'product_id'),)